...
uint32_t weight_wra; /* weight for WRA factor */
...
int main (int argc, char **argv)
{
	...
	if (working_cluster_rec) {
		...
		weight_wra  = slurm_ctl_conf_ptr->priority_weight_wra;
	...
	info("PRIORITY: weight_wra=%d", weight_wra);
