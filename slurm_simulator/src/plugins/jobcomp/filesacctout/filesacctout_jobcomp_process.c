	...
	//	info("fgets: %d", count);
		...
		info("fptr: %s",fptr2);
                ...
                while (fptr2) {
                    ...
                    if (i == 3 || i == 5 || i == 10 || i == 11 || i == 14 || i == 15 || i == 16 || i == 19 || i == 20) {
                        fptr2 = strstr(fptr2, " ");
                        fptr2 = strstr(fptr2, "=");
			//info("fptr: i=%d, blank %s", i, fptr2);
                    }
                    if (i == 4) {
			...
			strtok(str, " ");
			//info("fptr: str=%s", str);
                        fptr = str_replace(str, ":", " :");
			fptr = strstr(str, ":");
                        fptr ++;
			//info("fptr: tmp=%s, fptr=%s", fptr, fptr3);
                        strcat(fptr3, " TimeLimit=");
                        strcat(fptr3, fptr);
                        fptr2 = strstr(fptr2, " ");
                        fptr2 = strstr(fptr2, "=");
                    }
