					  ...
					  uint16_t protocol_version)
{
	...
	if (protocol_version >= SLURM_16_05_PROTOCOL_VERSION) {
		...
		packdouble(object->priority_wra, buffer);
					   ...
					   uint16_t protocol_version)
{
	...
	*object = (void *) object_ptr;
	...
	if (protocol_version >= SLURM_16_05_PROTOCOL_VERSION) {
		...
		safe_unpackdouble(&object_ptr->priority_wra, buffer);
			 ...
			 uint16_t protocol_version)
{
	...
	if (protocol_version >= SLURM_17_02_PROTOCOL_VERSION) {
		...
		pack32(build_ptr->priority_weight_wra, buffer);
			   ...
			   Buf buffer, uint16_t protocol_version)
{
	...
	*build_buffer_ptr = build_ptr;
	...
	if (protocol_version >= SLURM_17_02_PROTOCOL_VERSION) {
		...
		safe_unpack32(&build_ptr->priority_weight_wra, buffer);
