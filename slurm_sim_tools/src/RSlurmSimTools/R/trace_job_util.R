...
# devtools::document("/home/slurm/slurm_sim_ws_seth/slurm_sim_tools/src/RSlurmSimTools")
# install.packages("/home/slurm/slurm_sim_ws_seth/slurm_sim_tools/src/RSlurmSimTools", repos = NULL, type="source")
