...
In this tutorial we will performe simulation in _~/slurm_sim_ws_seth/sim/micro/baseline_. To initiate new directory from supplied Slurm configuration run:
...
Parameters specific for simulator are set in etc/sim.conf. Open and examin ~/slurm_sim_ws_seth/sim/micro/baseline/etc/sim.conf
