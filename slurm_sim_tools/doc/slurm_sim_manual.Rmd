...
/home/slurm                       - Slurm user home derectory
      └── slurm_sim_ws_seth            - Slurm simulator work space
...
install.packages("~/slurm_sim_ws_seth/slurm_sim_tools/src/RSlurmSimTools", repos = NULL, type="source")
```
...
```{bash, eval=FALSE}
cd
mkdir slurm_sim_ws_seth
cd slurm_sim_ws_seth
...
Run configure:
```{bash,eval=FALSE}
../slurm_simulator/configure --prefix=/home/slurm/slurm_sim_ws_seth/slurm_opt --enable-simulator \
...
```{bash, eval=FALSE}
cd ~/slurm_sim_ws_seth
mkdir -p ~/slurm_sim_ws_seth/sim/micro
```
...
In this tutorial we will perform simulation in _~/slurm_sim_ws_seth/sim/micro/baseline_. To initiate new directory from supplied Slurm configuration run:

```{bash, eval=FALSE}
cd ~/slurm_sim_ws_seth
~/slurm_sim_ws_seth/slurm_sim_tools/src/cp_slurm_conf_dir.py -o -s ~/slurm_sim_ws_seth/slurm_opt \
    ~/slurm_sim_ws_seth/slurm_sim_tools/tutorials/micro_cluster/etc ~/slurm_sim_ws_seth/sim/micro/baseline
```
Output:
```
[2017-04-27 15:16:22,800]-[INFO]: Creating directory: /home/slurm/slurm_sim_ws_seth/sim/micro/baseline
[2017-04-27 15:16:22,800]-[INFO]: Copying files from \
    /home/slurm/slurm_sim_ws_seth/slurm_sim_tools/tutorials/micro_cluster/etc \
...
sim/micro/baseline now contains etc directory with Slurm configuration. The paths in _etc/slurm.conf_ and _etc/slurmdbd.conf_ are updated to place outputs within _~/slurm_sim_ws_seth/sim/micro/baseline_.
...
```{bash, eval=FALSE}
SLURM_CONF=/home/slurm/slurm_sim_ws_seth/sim/micro/baseline/etc/slurm.conf /home/slurm/slurm_sim_ws_seth/slurm_opt/sbin/slurmdbd -Dvvvv
```

In separate terminal populate SlurmDB using Slurm _sacctmgr_ utility:
```{bash, eval=FALSE}
export SLURM_CONF=/home/slurm/slurm_sim_ws_seth/sim/micro/baseline/etc/slurm.conf
SACCTMGR=/home/slurm/slurm_sim_ws_seth/slurm_opt/bin/sacctmgr
...
Parameters specific for simulator are set in etc/sim.conf. Open and examine ~/slurm_sim_ws_seth/sim/micro/baseline/etc/sim.conf
...
sdiagPeriod=60
sdiagFileOut = /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/sdiag.out
sprioPeriod=60
sprioFileOut = /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/sprio.out
sinfoPeriod=60
sinfoFileOut = /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/sinfo.out
squeuePeriod=60
squeueFileOut = /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/squeue.out

SimStats = /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/simstat.out

#file with jobs to simulate
JobsTraceFile=/home/slurm/slurm_sim_ws_seth/slurm_sim_tools/tutorials/micro_cluster/test.trace
```
...
```{bash, eval=FALSE}
cd ~/slurm_sim_ws_seth/sim/micro/baseline
~/slurm_sim_ws_seth/slurm_sim_tools/src/run_sim.py -e ~/slurm_sim_ws_seth/sim/micro/baseline/etc -s ~/slurm_sim_ws_seth/slurm_opt -d
```

```
[2017-05-04 11:30:20,280]-[INFO]: slurm.conf: /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/etc/slurm.conf
[2017-05-04 11:30:20,281]-[INFO]: slurmdbd: /home/slurm/slurm_sim_ws_seth/slurm_opt/sbin/slurmdbd
[2017-05-04 11:30:20,281]-[INFO]: slurmctld: /home/slurm/slurm_sim_ws_seth/slurm_opt/sbin/slurmctld
...
[2017-05-04 11:30:20,311]-[INFO]: deleting previous JobCompLoc file: /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/jobcomp.log
[2017-05-04 11:30:20,312]-[INFO]: deleting previous SlurmctldLogFile file: /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/slurmctld.log
[2017-05-04 11:30:20,330]-[INFO]: deleting previous SlurmSchedLogFile file: /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/slurm_sched.log
[2017-05-04 11:30:20,330]-[INFO]: deleting previous SlurmdbdPidFile file: /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/var/run/slurmdbd.pid
[2017-05-04 11:30:20,331]-[INFO]: deleting previous sdiagFileOut file: /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/sdiag.out
[2017-05-04 11:30:20,331]-[INFO]: deleting previous sprioFileOut file: /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/sprio.out
[2017-05-04 11:30:20,333]-[INFO]: deleting previous SimStats file: /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/simstat.out
[2017-05-04 11:30:20,333]-[INFO]: deleting previous sinfoFileOut file: /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/sinfo.out
[2017-05-04 11:30:20,334]-[INFO]: deleting previous squeueFileOut file: /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/squeue.out
[2017-05-04 11:30:20,335]-[INFO]: deleting previous StateSaveLocation files from /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/var/state
...
[2017-05-04 11:30:35,363]-[INFO]: Copying results to :/home/slurm/slurm_sim_ws_seth/slurm_simulator/results
[2017-05-04 11:30:35,363]-[INFO]: copying resulting file /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/jobcomp.log to /home/slurm/slurm_sim_ws_seth/slurm_simulator/results
[2017-05-04 11:30:35,364]-[INFO]: copying resulting file /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/slurmctld.log to /home/slurm/slurm_sim_ws_seth/slurm_simulator/results
[2017-05-04 11:30:35,509]-[INFO]: copying resulting file /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/sdiag.out to /home/slurm/slurm_sim_ws_seth/slurm_simulator/results
[2017-05-04 11:30:35,511]-[INFO]: copying resulting file /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/sprio.out to /home/slurm/slurm_sim_ws_seth/slurm_simulator/results
[2017-05-04 11:30:35,520]-[INFO]: copying resulting file /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/simstat.out to /home/slurm/slurm_sim_ws_seth/slurm_simulator/results
[2017-05-04 11:30:35,521]-[INFO]: copying resulting file /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/sinfo.out to /home/slurm/slurm_sim_ws_seth/slurm_simulator/results
[2017-05-04 11:30:35,521]-[INFO]: copying resulting file /home/slurm/slurm_sim_ws_seth/sim/micro/baseline/log/squeue.out to /home/slurm/slurm_sim_ws_seth/slurm_simulator/results
[2017-05-04 11:30:35,527]-[INFO]: processing /home/slurm/slurm_sim_ws_seth/slurm_simulator/results/sprio.out to /home/slurm/slurm_sim_ws_seth/slurm_simulator/results/sprio.csv
writing output to: /home/slurm/slurm_sim_ws_seth/slurm_simulator/results/sprio.csv
[2017-05-04 11:30:35,781]-[INFO]: processing /home/slurm/slurm_sim_ws_seth/slurm_simulator/results/simstat.out to /home/slurm/slurm_sim_ws_seth/slurm_simulator/results/simstat_backfill.csv
...
```{bash, eval=FALSE}
cd ~/slurm_sim_ws_seth/sim/micro/baseline
~/slurm_sim_ws_seth/slurm_sim_tools/src/run_sim.py \
    -e ~/slurm_sim_ws_seth/sim/micro/baseline/etc \
    -s ~/slurm_sim_ws_seth/slurm_opt \
...
sacct_base <- read_sacct_out("~/slurm_sim_ws_seth/sim/micro/baseline/log/jobcomp.log")
#Read backfill stats
bf_base <- read_simstat_backfill("~/slurm_sim_ws_seth/sim/micro/baseline/results/simstat_backfill.csv")
...
```{bash, eval=FALSE}
~/slurm_sim_ws_seth/slurm_sim_tools/src/cp_slurm_conf_dir.py -o \
    -s ~/slurm_sim_ws_seth/slurm_opt \
    ~/slurm_sim_ws_seth/sim/micro/baseline/etc ~/slurm_sim_ws_seth/sim/micro/bf3
```

Change bf_max_job_user from 3 to 20 in ~/slurm_sim_ws_seth/sim/micro/baseline/etc/slurm.conf.

Now rerun simulator

```{bash, eval=FALSE}
cd ~/slurm_sim_ws_seth/sim/micro/bf3
~/slurm_sim_ws_seth/slurm_sim_tools/src/run_sim.py -e ~/slurm_sim_ws_seth/sim/micro/bf3/etc -s ~/slurm_sim_ws_seth/slurm_opt -d
```
...
sacct_bf3 <- read_sacct_out("~/slurm_sim_ws_seth/sim/micro/bf3/log/jobcomp.log")
...
bf_bf3 <- read_simstat_backfill("~/slurm_sim_ws_seth/sim/micro/bf3/results/simstat_backfill.csv")
